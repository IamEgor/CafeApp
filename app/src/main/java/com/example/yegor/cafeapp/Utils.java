...
public class Utils {
    ...
    public static List<CategoryModel> getCategoryModels() {
        ...
        ArrayList<CategoryModel> categoryModels = new ArrayList<>(14);

        categoryModels.add(new CategoryModel.Builder()
                .setId(24)
                .setCategory("Шашлыки")
        ...
        categoryModels.add(new CategoryModel.Builder()
                ...
                .create());
        categoryModels.add(new CategoryModel.Builder().setId(10)
                .setCategory("Десерты")
